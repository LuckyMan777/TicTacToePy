...
def alphabeta(game_state: State, alpha=-2, beta=2, our_turn=True):
    ...
    if our_turn:
        ...
        for move in game_state.get_empty_indices():
            child = game_state.make_move(utils.get_2d_indices(move), True)
